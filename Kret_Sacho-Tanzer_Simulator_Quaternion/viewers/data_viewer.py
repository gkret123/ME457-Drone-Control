...
class DataViewer:
    ...
    def __update_data(self, true_state, estimated_state, commanded_state, delta, t):
        ...
        if true_state != None:
            ...
            self._plotter.add_data_point(plot_id='alpha', data_label='alpha', xvalue=t, yvalue=true_state.alpha[0])
            self._plotter.add_data_point(plot_id='beta', data_label='beta', xvalue=t, yvalue=true_state.beta[0])
